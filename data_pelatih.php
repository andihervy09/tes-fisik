<?php 
  require 'koneksi.php';
  $data = query("SELECT * FROM pelatih
                  INNER JOIN cabor ON pelatih.id_cabor = cabor.id_cabor 
                  ORDER BY nama ASC"); 
 ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="section">
          <div class="section-header">
            <h1>Data Pelatih</h1>
             ...
             <div class="col-12 ">
              <div class="buttons">
                     <a href="tambahp.php" class="btn btn-outline-dark">Tambah Data pelatih</a></div>
                <div class="card">
                  <div class="card-header">
                    <h4>Data Pelatih Cabor</h4>
                  </div>
                      ...
                      <table class="table table-striped table-md">
                        ...
                        <tr>
                          ...
                          <?php foreach ($data as $row){
                            ...
                            <td>
                              <div class="buttons">
                                <a href="prestasi.php?id_pelatih=<?= $row['id_pelatih'];?>"class="btn btn-primary">Cek Prestasi</a>
                              </div>
                               <div class="buttons">
