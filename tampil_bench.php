<?php 
  ...
  $data = query("SELECT * FROM benchmark 
                  INNER JOIN atlet ON benchmark.id_atlet = atlet.id_atlet");
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
                      ...
                      <table class="table table-striped table-md">
                        ...
                        <tr>
                          ...
                          <?php foreach ($data as $row){
                            ...
                            <td><?php echo $row['run20m']; ?></td>
                            <td><?php echo $row['shutle']; ?></td>
                            <td><?php echo $row['flexibility'] ?></td>
                            <td><?php echo $row['jump_kaka']; ?></td>
                            <td><?php echo $row['jump_kaki']; ?></td>
                            <td><?php echo $row['situp']; ?></td>
                            <td><?php echo $row['pushup']; ?></td>
                            <td><?php echo $row['bleep']; ?></td>
                            <td>
                               <div class="buttons">
                                <a href="edit_bench.php?id_tes=<?= $row['id_tes']; ?>" class="btn btn-primary">Edit</a>
                              </div>
                              <div class="buttons">
