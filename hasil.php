<?php 
  ...
  $data = query("SELECT * FROM hasil 
                  INNER JOIN atlet ON hasil.id_atlet = atlet.id_atlet ORDER BY nama ASC");
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Data Atlet &mdash; Stisla</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <br>
             ...
             <div class="col-12 ">
                <div class="buttons">
                  <a href="input_hasil.php" class="btn btn-outline-dark">Tambah Data hasil</a></div>
                <div class="card">
                  <div class="card-header">
                    <h4>Data hasil Atlet Cabor</h4>
                  </div>
                      ...
                      <table class="table table-striped table-md">
                        ...
                        <tr>
                          ...
                          <?php foreach ($data as $row){
                            ...
                            <td>
                               <div class="buttons">
                                <a href="edit_hasil.php?id_tes=<?= $row['id_tes']; ?>" class="btn btn-primary">Edit</a>
                              </div>
                              <div class="buttons">
                                <a href="hapus_hasil.php?id_tes=<?= $row['id_tes']; ?>" onclick="return confirm('Anda Yakin?')" class="btn btn-primary">Hapus</a>
                              </div>
                            </td>
                            <td>
                            </td>
