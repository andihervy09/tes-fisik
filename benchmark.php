<?php 
  ...
  $data = query("SELECT * FROM benchmark ORDER BY tanggal");
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <br>
             ...
             <div class="col-12 ">
                <div class="buttons">
                  <a href="input_bench.php" class="btn btn-outline-dark">Tambah Data bench</a></div>
                <div class="card">
                  <div class="card-header">
                    <h4>Data bench Atlet Cabor</h4>
                  </div>
                        ...
                        <tr>
                          ...
                          <?php foreach ($data as $row){
                            ...
                            <td><?php echo $row['bleep']; ?> Kali</td>
                             <td>
                               <div class="buttons">
                                <a href="edit_bench.php?id_bench=<?= $row['id_bench']; ?>" class="btn btn-primary">Edit</a>
                              </div>
                              <div class="buttons">
                                <a href="hapus_bench.php?id_bench	=<?= $row['id_bench']; ?>" onclick="return confirm('Anda Yakin?')" class="btn btn-primary">Hapus</a>
                              </div>
                            </td>
                            <td>
                            </td>
